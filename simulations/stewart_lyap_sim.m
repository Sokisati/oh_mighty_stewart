...
%% =========================================================
%  PID PARAMETERS
%  Using Analytical Baseline from config.txt
%% =========================================================
% Kp, Ki, Kd are loaded via stewart_setup.m -> load_config
...
fprintf('Configuring Lyapunov (Mode 8) Adaptive Parameters...\n');
sim_params.lyap.active = true;
sim_params.lyap.lambda = 5.0;
sim_params.lyap.gamma_p = 500.0;
sim_params.lyap.sigma_p = 2.0;
sim_params.lyap.gamma_i = 200.0;
sim_params.lyap.sigma_i = 1.0;
sim_params.lyap.gamma_d = 50.0;
sim_params.lyap.sigma_d = 5.0;
...
title(ax,'Lyapunov Adaptive PID - Stewart Platform', ...
...
mode_txt  = text(ax,-lim*.9,-lim*.9,h0*2.05,'LYAPUNOV: ON', ...
...
for i = 1:N
    ...
    if is_disturb
        ...
        set(mode_txt,'String','LYAPUNOV: ON','Color',[0.3 1.0 0.4]);
    end
...
%% =========================================================
fprintf('\n================================================\n');
fprintf('         LYAPUNOV PERFORMANCE METRICS\n');
fprintf('================================================\n');
